...
void LightingMap::renderContainer(glm::mat4 view, glm::mat4 projection, Shader& shader) 
{
...
void LightingMap::renderLightSource(glm::mat4 view, glm::mat4 projection, Shader& shader) 
{
